...
def test_pipeline_runs_successfully():
    ...
    input_file_path = "tests/examples/generative_tuning/example_generative_tuning_data.jsonl"
    input_file_path = "/Users/ranjanl/github/generative_data_prep/tests/examples/ \
        generative_tuning/example_generative_tuning_data.jsonl"
    output_path = f"tests/examples/tester_{secrets.token_hex(8)}"
    command = f"python -m generative_data_prep pipeline --input_file_path={input_file_path} \
        --output_path={output_path} --max_seq_length=1024"
