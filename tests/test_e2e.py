...
@pytest.mark.parametrize(
    ...
    [('pipeline_test', False, True, 'prompt', 'completion', 'False', True,
      1024, PackingConfig.get_default(), BoundaryType.JSONL,
      BoundaryType.JSONL, None, None, None, 0.2, 0.1),
     ('pretraining_txt', False, True, 'prompt', 'completion', 'False', False,
      1024, PackingConfig.get_default(), BoundaryType.JSONL,
      BoundaryType.JSONL, 32, 0, 0, None, None),
     ('pretraining', False, True, 'prompt', 'completion', 'False', False, 1024,
      PackingConfig.get_default(), BoundaryType.JSONL, BoundaryType.JSONL, 32,
      0, 0, None, None),
     ('generative_tuning', False, True, 'prompt', 'completion', 'False', False,
      1024, PackingConfig.from_str('single::drop'), BoundaryType.JSONL,
      BoundaryType.JSONL, 32, 0, 0, None, None),
     ('dialogue', False, True, 'prompt', 'completion', 'False', False, 1024,
      PackingConfig.from_str('single::truncate_right'), BoundaryType.JSONL,
      BoundaryType.JSONL, 32, 0, 0, None, None),
     ('metaICL', False, True, 'prompt', 'completion', 'False', False, 1024,
      PackingConfig.from_str('greedy::drop'),
