...
@pytest.mark.parametrize(
    ...
    [(MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_1, 1, np.array([[0, 1, 2, 3]
                                                                                      ]), np.array([[0, -1, -2, -3]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_2, 1, np.array([[0, 1, 2, 3]
                                                                                      ]), np.array([[0, -1, -2, -3]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_3, 1, np.array([[0, 1, 2, 3]
                                                                                      ]), np.array([[0, -1, -2, -3]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_1, 2, np.array(
         [[0, 1, 2, 3], [1, 2, 3, 4]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_2, 2, np.array(
         [[0, 1, 2, 3], [1, 2, 3, 4]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_3, 2, np.array(
         [[0, 1, 2, 3], [1, 2, 3, 4]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_1, 3,
      np.array([[0, 1, 2, 3], [1, 2, 3, 4], [2, 3, 4, 5]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2], [2, 1, 0, -1]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_2, 3,
      np.array([[0, 1, 2, 3], [1, 2, 3, 4], [2, 3, 4, 5]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2], [2, 1, 0, -1]])),
     (MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, MAX_SEQ_LENGTH, EOS, CHUNK_SIZE_3, 3,
      np.array([[0, 1, 2, 3], [1, 2, 3, 4], [2, 3, 4, 5]]), np.array([[0, -1, -2, -3], [1, 0, -1, -2], [2, 1, 0, -1]]))]
)
def test_hfd5_text_buffer_write(max_seq_length1: int, tokenized_line: TokenizedSequence, chunk_size: int,
