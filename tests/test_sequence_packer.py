...
@pytest.fixture
def packing_config(packing_style: PackingStyleType,
                   overflow_type: OverflowType):
    return PackingConfig(packing_style, overflow_type)


@pytest.fixture
def sequence_packer(max_seq_length: int, eos_token_id: int,
                    packing_config: PackingConfig) -> SequencePacker:
...
@pytest.mark.parametrize(
    'length,max_seq_length,eos_token_id,packing_style,overflow_type,length_2,max_seq_length_2,eos_token_id_2,\
        ...
        (3, 5, -1, PackingStyleType.SINGLE, OverflowType.DROP, 6, None, None,
         []),
        (3, 5, -1, PackingStyleType.SINGLE, OverflowType.TRUNCATE_LEFT, 6,
         None, None, [4, 5]),
        (3, 5, -1, PackingStyleType.SINGLE, OverflowType.TRUNCATE_RIGHT, 6,
         None, None, [0, 1]),
    ])
def test_handle_overflow(sequence_packer: SequencePacker,
...
@pytest.mark.parametrize(
    ...
    [
        (5, -1, PackingStyleType.SINGLE, OverflowType.DROP,
         [3, 2, 10, 2, 2, 5], [(3, 2), (2, 3), (2, 3), (2, 3), (5, 0)]),
        (5, -1, PackingStyleType.SINGLE,
         OverflowType.TRUNCATE_LEFT, [3, 2, 10, 2, 2, 5], [(3, 2), (2, 3),
                                                           (5, 0), (2, 3),
                                                           (2, 3), (5, 0)]),
        (5, -1, PackingStyleType.SINGLE,
         OverflowType.TRUNCATE_RIGHT, [3, 2, 10, 2, 2, 5], [(3, 2), (2, 3),
                                                            (5, 0), (2, 3),
                                                            (2, 3), (5, 0)]),
        (5, -1, PackingStyleType.GREEDY, OverflowType.DROP,
         [3, 2, 10, 2, 2, 5], [(5, 0), (4, 1), (5, 0)]),
        (5, -1, PackingStyleType.GREEDY, OverflowType.TRUNCATE_LEFT,
         [3, 2, 10, 2, 2, 5], [(5, 0), (5, 0), (4, 1), (5, 0)]),
        (5, -1, PackingStyleType.GREEDY, OverflowType.TRUNCATE_RIGHT,
         [3, 2, 10, 2, 2, 5], [(5, 0), (5, 0), (4, 1), (5, 0)]),
        (5, -1, PackingStyleType.FULL, None, [3, 2, 10, 2, 2, 5], [(5, 0),
                                                                   (5, 0),
                                                                   (5, 0),
                                                                   (5, 0),
                                                                   (4, 1)]),
    ])
def test_sequence_packer(sequence_packer: SequencePacker, max_seq_length: int,
                         eos_token_id: int, article_lengths: List[int],
    ...
    assert all(max_seq_length == sum(expected_tuple)
               for expected_tuple in expected), err_msg
    ...
    for sequence, (num_compl_tokens,
                   num_pad_tokens) in zip(sequences, expected):
        ...
        for i in range(num_pad_tokens):
            assert sequence[i + num_compl_tokens] == (eos_token_id,
