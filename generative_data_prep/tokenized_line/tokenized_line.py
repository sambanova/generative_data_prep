...
class TokenizedSequence(TokenizedLine):
    ...
    def __init__(self, tokens: List[Token], max_seq_length: int, eos_token_id: int):
        ...
        Args:
            tokens:  The tokens that make up this tokenized line, each token has an id, a type_id and category_id
        ...
        assert len(tokens) <= max_seq_length, err_msg
    ...
    def pad(self):
        ...
        self._tokens += [Token(self.eos_token_id, TokenTypeIds.PADDING, -1)] * padding_size
