...
> [jsonlines with empty prompts and text in the completions.](examples/pretraining/pretraining_data.jsonl)
...
#### Example data
> [Jsonlines with a prompt and completion](examples/generative_tuning/example_generative_tuning_data.jsonl)
