...
| `add_category_metadata` | bool | False | If you include this flag, then the 'category' field from your input jsonls will be stored in the 'category_id' dataset in your output hdf5 files. This labels each tokens category and allows you to view training loss curves for each individual category. |
