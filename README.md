...
| `categories` | bool | False | If you include this flag, then the 'category' field from your input jsonls will be stored in the 'category_id' dataset in your output hdf5 files. You need to specify all the possible categories each data point could be classified as. You can pass this in as a comma separated list, or a file path to a newline separated text file, where each line is a category. |
