...
| `ignore_input_format_error` | bool | False | Include flag for True, no arguments | Permission to skip misformatted lines in the input file, number of skipped lines will be logged and skipped lines are stored in `output_path/json_error_log.log`. |
